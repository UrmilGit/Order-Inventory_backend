...
public class ProductController {
	...
	public ResponseEntity<Product> getProductsById(@PathVariable("id") int productId) {

		return new ResponseEntity<Product>(prod.getProductById(productId),HttpStatus.OK);

	}
 
 
	@GetMapping("/{productname}/prod")
	...
	public ResponseEntity<List<Product>> getSortedProductsByField(@PathVariable("field") String field) {
